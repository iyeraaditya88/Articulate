...
5. Disfluency: count filler words in the transcript (um, uh, like, you know, sort of, kind of, basically, actually, right?, I mean). Note the transcription may already have dropped some fillers; count only what appears.
